...
else echo 'Magneto built in cache is selected, varnish is not working. To enable varnish go to the Magento admin > stores > configuration > advanced > Full page caching'
